    ...
    public static class Exercise11
    {
        ...
        */
        public static void Run()
        {
            ...
            {
                for (int j = i; j <= i + 2 && j < GRID.Length; j++)
                {
                    if (char.IsDigit(GRID[j]))
                    {
                        numberString += GRID[j];
                    }
            ...
            result = Diagonal(result, numbersArray);
        ...
        private static long Diagonal(long result, int[,] numbersArray)
        {
            long product = 1;
            int counter = 0;
            ...
            int c = 0;
            int r = 0;
            for (int i = 0; i <= numbersArray.GetLength(1) - 4; i++)
            {
                c = i;
                counter = 0;
                r = 0;
                while (r <= numbersArray.GetLength(1) - 1 - i)
                {
            ...
            for (int i = 1; i <= numbersArray.GetLength(1) - 4; i++)
            {
                r = i;
                counter = 0;
                c = 0;
                while (c <= numbersArray.GetLength(1) - 1 - i)
                {
                    product *= numbersArray[r, c];
                    c++;
                    r++;
